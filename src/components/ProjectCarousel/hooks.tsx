...
const useProjectCarousel = () => {
  ...
  const getProjects = useMemo(() => map(projects.ids, (id) => projects.entities[id]), [projects])
  ...
  const renderProjects = useCallback(() => {
    ...
    return map(getProjects, (project) => (
      <div key={project.name} className='h-full w-full flex justify-start items-center'>
        <div
